...
$(() => {
    ...
    if (has_slide) {
        slides_data_unique =  { name: 'Slide 01', active: true, type: 'product', 
        data: {product: "NskiW3Re",id: "https://storage.googleapis.com/zap-delivery-285220.appspot.com/stores/KY41M76LEi2bR6nra73hs0r0S/bOnOCt6DxK.png" } }
           
    }
    else {
        slides_data_unique =  { name: "", active: true, type: "", 
        data: {product: "",id: "", url:"" } }
    }
    ...
    const status_promo = booleanButton(uniKey(), false, true);
    ...
    const button_confirmar = Button(uniKey(), {
        ...
        click: (() => {
            ...
            if (is_valid) {
                let array = option_product_selected.value;
                array = JSON.parse(array);
                console.log(array);
                slides_data_unique.name = input_name.value;
                slides_data_unique.type = $('option:selected', input_type).val();
                slides_data_unique.data.id = array.avatar;
                slides_data_unique.data.product = array.value;
      
                console.log(slides_data_unique);
