...
function nightModeButton(ind, opt) {
    ...
    var input_id = uniKey(5);

    var input = inputField(input_id, {
        classNameB: 'tgl tgl-flat',
        type: 'checkbox',
        onchange: (function (e) {
            if (this.checked) {
                $('body').addClass('nightmode');
                setCookie('nightmode', 'on', '30');
            } else {
                $('body').removeClass('nightmode');
                setCookie('nightmode', 'off', '30');
            }
        }),
    })
